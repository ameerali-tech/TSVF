        ...
        <div class="col-sm-12">
          ...
          <div class="card">
            ...
            <div class="card-header">
              ...
              <a href="<?=base_url();?>Supplier/add_purchase_bills" class="btn btn-sm btn-default pull-right"><i class="fa fa-plus"></i> Add Purchase Bill</a>
            </div> <br><br>
...
<script type="text/javascript" language="javascript">
 $(document).ready(function(){
    ...
    $('#orders').DataTable({
      ...
      "serverSide" : true,
      "ajax" : {
        url:"<?=site_url('Supplier/getBillData')?>/"+status,
        type:"POST"
      },
      dom: 'lBfrtip',
 ...
 function showViewModal(id){
   ...
   $.ajax({
    url : '<?=site_url('Supplier/getBillInfo/')?>'+id,
//    dataType : 'json',
    success :function(data) { 
