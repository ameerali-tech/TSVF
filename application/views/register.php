            ...
            <div class="card-body login-img">
              <div class="row m-0">
                ...
                <div class="col-lg-6 col-md-12 bg-white px-4 pt-3">
                  <form class="login-form" action="<?=site_url('users/register')?>" method="post">
                  <h4 class="mb-2 card-title">Create New Account</h4>
                  ...
                  <?php } ?>
                    <?php
                        ...
                        ?>
                  <select class="form-control mb-3" name="warehouse_id" required>
                  ...
                  <div class="row ">
                    ...
                    <div class="col-md-6">
                      <input type="text" class="form-control mb-3" name="ph_num" placeholder="Phone Number" required />
                    </div>
                  </div>
